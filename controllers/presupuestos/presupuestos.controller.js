...
const createPresupuesto = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      `INSERT INTO presupuestos (nombre, descripcion, labor_id, obra_id, estado_id, total_estimado, costo_mano_obra, propietario_id)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *`,
      [nombre, descripcion, labor_id ?? null, obra_id, estadoBorrador, costoManoObra, costoManoObra, propietario_id]
    );
